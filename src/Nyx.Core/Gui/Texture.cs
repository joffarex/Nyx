...
namespace Nyx.Core.Gui
{
    ...
    internal class Texture : IDisposable
    {
        ...
        public unsafe Texture(GL gl, string name, int width, int height, IntPtr data, bool generateMipmaps = false,
            bool srgb = false)
        {
            _gl = gl;
        ...
        public void SetAnisotropy(float level)
        {
            ...
            _gl.TextureParameter(GlTexture, textureMaxAnisotropy, OpenGl.Clamp(level, 1, MaxAniso.GetValueOrDefault()));
        }
