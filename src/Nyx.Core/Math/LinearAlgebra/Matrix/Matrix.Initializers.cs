...
namespace Nyx.Core.Math.LinearAlgebra.Matrix
{
    public partial class Matrix : ICloneable, IEquatable<Matrix>
    {
        ...
        /// </summary>
        public static Matrix Create2DIdentityMatrix()
        {
            return CreateIdentityMatrix(2);
        }

        /// <summary>
        ///     Creates 3-dimensional identity matrix.
        /// </summary>
        public static Matrix Create3DIdentityMatrix()
        {
        ...
        {
            return new Matrix(MatrixFunctions.MatrixFunctions.CreateIdentityMatrix(length));
        }
        ...
        {
            return new Matrix(MatrixFunctions.MatrixFunctions.GenerateRandomMatrix(numRows, numCols, maxValue));
        }
        ...
        /// <summary>
        ///     Creates transformation matrix from the specified matrices. Technically multiplies n-dimensional matrix by the
        ///     specified matrices.
        /// </summary>
        public static Matrix CreateTransformationMatrix(int dimension, params Matrix[] matrices)
        {
            Matrix matrix = CreateIdentityMatrix(dimension);
            if (matrices != null)
            {
        ...
        public static Matrix CreateTransformationMatrix(int dimension, params double[][,] matrices)
        {
            ...
            if (matrices != null)
            {
                foreach (double[,] mat in matrices)
                {
                    matrix = matrix.Multiply(mat);
                }
            }
        ...
        {
            return new Matrix(MatrixFunctions.MatrixFunctions.Create2DReflectionMatrix(axis));
        }
        ...
        {
            return new Matrix(MatrixFunctions.MatrixFunctions.Create3DReflectionMatrix(plane));
        }
        ...
        {
            return new Matrix(MatrixFunctions.MatrixFunctions.Create2DShearingMatrix(factor, axis));
        }
        ...
        {
            return new Matrix(MatrixFunctions.MatrixFunctions.Create3DShearingMatrix(factor, axis));
        }
